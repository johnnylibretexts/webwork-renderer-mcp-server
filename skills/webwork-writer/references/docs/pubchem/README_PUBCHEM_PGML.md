...
```bash
cd problems/biochemistry-problems/PUBCHEM
...
2. Or use `webwork_render_problem` MCP tool to render and verify
3. Or use `webwork_validate_syntax` MCP tool for quick validation
